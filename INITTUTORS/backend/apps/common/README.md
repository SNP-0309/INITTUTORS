...
Shared, cross-app building blocks: base abstract models, shared enums/constants (roles, attendance/student statuses), the standard API response envelope, pagination helpers, custom error classes, and audit utilities. No feature logic — imported by other apps.
