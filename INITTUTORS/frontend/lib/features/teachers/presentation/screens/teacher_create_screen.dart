...
class TeacherCreateScreen extends ConsumerStatefulWidget {
  const TeacherCreateScreen({super.key});

  @override
  ConsumerState<TeacherCreateScreen> createState() => _TeacherCreateScreenState();
}

class _TeacherCreateScreenState extends ConsumerState<TeacherCreateScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      await ref.read(teacherControllerProvider.notifier).createTeacher(data);
      if (mounted) {
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'Specialization (e.g. Physics, Chemistry)',
                    border: OutlineInputBorder(),
                  ),
                ),
                const SizedBox(height: AppTokens.space3),
